...
<html lang="zxx">
    ...
    <!-- Mirrored from htmldemo.hasthemes.com/hono/hono/my-account.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Jan 2021 00:32:25 GMT -->
                    ...
                    <div class="col-sm-12 col-md-9 col-lg-9">
                        ...
                        <div class="tab-content dashboard_content"
                            ...
                            <div class="tab-pane fade show active"
                                id="dashboard">
                                <h4>Dashboard </h4>
                                <p>From your account dashboard. you can easily
                                    check &amp; view your <a href="#">recent
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>May 10, 2018</td>
                                                <td><span
                                                        class="success">Completed</span></td>
                                                <td>$25.00 for 1 item </td>
                                                <td><a href="{{ route('cart') }}"
                            ...
                            <div class="tab-pane fade" id="downloads">
                                ...
                                <div class="table_page table-responsive">
                                    <table>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Shopnovilla - Free Real
                                                    Estate PSD Template</td>
                                                <td>May 10, 2018</td>
                                                <td><span
                                                        class="danger">Expired</span></td>
                                                <td><a href="#"
                                                        class="view">Click Here
                                                        To Download Your
                                                        File</a></td>
                                            </tr>
                                            <tr>
                                                <td>Organic - ecommerce html
                                                    template</td>
                                                <td>Sep 11, 2018</td>
                                                <td>Never</td>
                                                <td><a href="#"
                            ...
                            <div class="tab-pane" id="address">
                                <p>The following addresses will be used on the
