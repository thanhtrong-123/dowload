...
<html lang="zxx">
    ...
    <!-- Mirrored from htmldemo.hasthemes.com/hono/hono/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Jan 2021 00:32:25 GMT -->
    ...
    <body>
        ...
        <div class="about-top">
            <div class="container">
                <div
                    class="row d-flex align-items-center justify-content-between d-sm-column">
                    <div class="col-md-6">
                        <div class="about-img" data-aos="fade-up"
                            data-aos-delay="0">
                            <div class="img-responsive">
                                <img src="assets/images/about/img-about.jpg"
                                    alt>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="content" data-aos="fade-up"
                            ...
                            <h5 class="semi-title">We believe that every project
                                existing in digital world is a result of an idea
                                and every idea has a cause.</h5>
                            <p>For this reason, our each design serves an idea.
                                Our strength in design is reflected by our name,
                                our care for details. Our specialist won't be
                                afraid to go extra miles just to approach near
                                perfection. We don't require everything to be
                                perfect, but we need them to be perfectly cared
                                for. That's a reason why we are willing to give
                                contributions at best. Not a single detail is
                                missed out under Billey's professional eyes.The
                                amount of dedication and effort equals to the
                                level of passion and determination. Get better,
                                together as one.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="content" data-aos="fade-up"
                            data-aos-delay="0">
                            <h4 class="title">Functionality meets
                                perfection</h4>
                            <p>In today’s day and age, one cannot underestimate
                                the importance of design, the art of creating
                                striking visuals to move and captivate your
                                audience. And as the world becomes more and more
                                digitized with each passing second, the
                    ...
                    <div class="col-md-6">
                        <div class="custom-progress m-t-40">
                            <div class="skill-progressbar" data-aos="fade-up"
                                data-aos-delay="0">
                                <h6 class="font--semi-bold m-b-15">UI/UX</h6>
                                <div class="line-progressbar"
                                    data-percentage="75"
                                    data-progress-color="#b19361"></div>
                            </div>
                            <div class="skill-progressbar" data-aos="fade-up"
                                data-aos-delay="200">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="service-promo-single-item"
                                ...
                                <div class="image">
                                    <img
                                        src="assets/images/icons/icon_about1.jpg"
                                        alt>
                                </div>
                                <div class="content">
                                    <h6 class="title">Creative Always</h6>
                                    <p>Stay creative with Billey and the huge
                                        collection of premade elements, layouts
                                        & effects.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="service-promo-single-item"
                                ...
                                <div class="image">
                                    <img
                                        src="assets/images/icons/icon_about2.jpg"
                                        alt>
                                </div>
                                <div class="content">
                                    <h6 class="title">Express Customization</h6>
                                    <p>Easy to install and configure the theme
                                        customization in a few clicks with
                                        Billey.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="service-promo-single-item"
                                ...
                                <div class="image">
                                    <img
                                        src="assets/images/icons/icon_about3.jpg"
                                        alt>
                                </div>
                                <div class="content">
                                    <h6 class="title">Premium Integrations</h6>
                                    <p>Integrated premium plugins in Billey is
                                        the secret weapon for your business to
                                        thrive.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="service-promo-single-item"
                                ...
                                <div class="image">
                                    <img
                                        src="assets/images/icons/icon_about4.jpg"
                                        alt>
                                </div>
                                <div class="content">
                                    <h6 class="title">Real-time Editing</h6>
                                    <p>Edit your work and preview the changes on
                                        the screen live with advanced page
                                        builder.</p>
                                </div>
                            </div>
                        </div>
        ...
        <!--  Start  Team Section    -->
        <div
            class="team-section section-top-gap-100 secton-fluid section-inner-bg">
                ...
                <div class="container">
                    <div class="row mb-n6">
                        <div class="col-xl-3 mb-5">
                            <div class="team-single" data-aos="fade-up"
                                data-aos-delay="0">
                                <div class="team-img">
                                    <img class="img-fluid"
                                        src="assets/images/team/leader1.png"
                                        alt>
                                </div>
                                <div class="team-content">
                                    <h6 class="team-name font--bold mt-5">Ms.
                                        Veronica</h6>
                        ...
                        <div class="col-xl-3 mb-5">
                            <div class="team-single" data-aos="fade-up"
                                ...
                                <div class="team-img">
                                    <img class="img-fluid"
                                        src="assets/images/team/leader2.png"
                                        alt>
                                </div>
                                <div class="team-content">
                                    <h6 class="team-name font--bold mt-5">Missa
                                        Santos</h6>
                        ...
                        <div class="col-xl-3 mb-5">
                            <div class="team-single" data-aos="fade-up"
                                ...
                                <div class="team-img">
                                    <img class="img-fluid"
                                        src="assets/images/team/leader3.png"
                                        alt>
                                </div>
                                <div class="team-content">
                                    <h6 class="team-name font--bold mt-5">Missa
                                        Santos</h6>
                                    <span class="team-title">Chief
                                        Officer</span>
                                    <ul class="team-social pos-absolute">
                                        <li><a href="#"><i
                                                    class="ion-social-facebook"></i></a></li>
                        ...
                        <div class="col-xl-3 mb-5">
                            <div class="team-single" data-aos="fade-up"
                                ...
                                <div class="team-img">
                                    <img class="img-fluid"
                                        src="assets/images/team/leader4.png"
                                        alt>
                                </div>
                                <div class="team-content">
                                    <h6 class="team-name font--bold mt-5">Lisa
                                        Antonia</h6>
    ...
    <!-- Mirrored from htmldemo.hasthemes.com/hono/hono/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Jan 2021 00:32:28 GMT -->
</html>
