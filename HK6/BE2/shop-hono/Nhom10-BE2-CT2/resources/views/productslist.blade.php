...
<html lang="zxx">
    ...
    <!-- Mirrored from htmldemo.hasthemes.com/hono/hono/products-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Jan 2021 00:32:23 GMT -->
        ...
        <div class="breadcrumb-section breadcrumb-bg-color--golden">
            <div class="breadcrumb-wrapper">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h3 class="breadcrumb-title">Shop - Grid Left
                                Sidebar</h3>
                            <div
                                ...
                                <nav aria-label="breadcrumb">
                                    <ul>
                                        ...
                                        <li class="active"
                                            aria-current="page">Shop Grid Left
                                            Sidebar</li>
                                    </ul>
                                </nav>
                            </div>
        ...
        <div class="shop-section">
            <div class="container">
                <div class="row flex-column-reverse flex-lg-row">
                    <div class="col-lg-3">
                        <!-- Start Sidebar Area -->
                        <div class="siderbar-section" data-aos="fade-up"
                            data-aos-delay="0">
                                    ...
                                    <ul class="sidebar-menu">
                                        <li>
                                            <ul class="sidebar-menu-collapse">
                                                ...
                                                <li
                                                    class="sidebar-menu-collapse-list">
                                                    <div class="accordion">
                                                        <a href="#"
                    ...
                    <div class="col-lg-9">
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div
                                        ...
                                        <div
                                            class="sort-tablist d-flex align-items-center">
                                            <ul
                                                class="tablist nav sort-tab-btn">
                                        ...
                                        <div
                                            class="sort-select-list d-flex align-items-center">
                                            <label class="mr-2">Sort By:</label>
                                            <form action="#">
                                                <fieldset>
                                                    <select name="speed"
                                                        id="speed">
                                                        <option>Sort by average
                                                            rating</option>
                                                        <option>Sort by
                                                            popularity</option>
                                                        <option
                        ...
                        <div class="sort-product-tab-wrapper">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                                        <div
                                            class="tab-content tab-animate-zoom">
                                            ...
                                            <div
                                                ...
                                                <div class="row">
                                                    <div
                                                        ...
                                                        <div
                                                            class="product-default-single-item product-color--golden"
                                                            data-aos="fade-up"
                                                            data-aos-delay="0">
                                                            <div
                                                                class="image-box">
                                            ...
                                            <div
                                                class="tab-pane sort-layout-single"
                                                id="layout-list">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <!-- Start Product Defautlt Single -->
                                                        <div
                                                            class="product-list-single product-color--golden">
                                                            <a
                                                                href="{{ route('productdetails') }}"
                                                            ...
                                                            <div
                                                                ...
                                                                <span
                                                                    class="product-list-price"><del>$30.12</del>
                                                                    $25.12</span>
                                                                <p>Lorem ipsum
                                                                    dolor sit
                                                                    amet,
                                                                    ...
                                                                    asperiores</p>
                                                                <div
                                                                    class="product-action-icon-link-list">
                                                                    <a href="#"
                                                                        data-bs-toggle="modal"
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <span
                                                                    class="product-list-price">$95.00</span>
                                                                <p>Lorem ipsum
                                                                    dolor sit
                                                                    amet,
                                                                    consectetur
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <span
                                                                    class="product-list-price">$75.00
                                                                    -
                                                                    $85.00</span>
                                                                <p>Lorem ipsum
                                                                    dolor sit
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <span
                                                                    class="product-list-price"><del>$25.12</del>
                                                                    $20.00</span>
                                                                <p>Lorem ipsum
                                                                    dolor sit
                                                                    amet,
                        ...
                        <div class="page-pagination text-center"
                            ...
                            <ul>
                                ...
                                <li><a href="#">3</a></li>
                                <li><a href="#"><i
                                            class="ion-ios-skipforward"></i></a></li>
                            </ul>
                        </div> <!-- End Pagination -->
                    </div>
                </div>
