...
<html lang="zxx">
    ...
    <head>
        ...
        <link rel="stylesheet"
            href="assets/css/plugins/jquery.lineProgressbar.css">
    ...
    <body>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div
                                ...
                                <div
                                    class="main-menu menu-color--white menu-hover-color--pink">
                                    <nav>
                                        <ul>
        ...
        <div id="offcanvas-add-cart"
            ...
            <div class="offcanvas-add-cart-wrapper">
                ...
                <ul class="offcanvas-cart-action-button">
                    <li><a href="{{ route('cart') }}" class="btn btn-block btn-pink">View
                            Cart</a></li>
                    <li><a href="{{ route('compare') }}"
                            class=" btn btn-block btn-pink mt-5">Checkout</a></li>
                </ul>
        ...
        <div id="offcanvas-wishlish"
            ...
            <div class="offcanvas-wishlist-wrapper">
                ...
                <ul class="offcanvas-wishlist-action-button">
                    <li><a href="{{ route('wishlist') }}" class="btn btn-block btn-pink">View
                            wishlist</a></li>
                </ul>
            </div> 
        ...
        <div id="search" class="search-modal">
            ...
            <form>
                ...
                <button type="submit"
                    class="btn btn-lg btn-pink">Search</button>
            </form>
        </div>
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <div class="hero-slider-content">
                                            <h4 class="subtitle">New
                                                collection</h4>
                                            <h1 class="title">New Series of <br>
                                                Degital Watch </h1>
                                            <a
                                                href="{{ route('productdetails') }}"
                                                class="btn btn-lg btn-pink">shop
                                                now </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <div class="hero-slider-content">
                                            <h4 class="subtitle">New
                                                collection</h4>
                                            <h1 class="title">Best Of HiFi <br>
                                                Loud Speaker</h1>
                                            <a
                                                href="{{ route('productdetails') }}"
                                                class="btn btn-lg btn-pink">shop
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="service-promo-single-item"
                                ...
                                <div class="image">
                                    <img
                                        src="assets/images/icons/service-promo-5.png"
                                        alt>
                                </div>
                                <div class="content">
                                    <h6 class="title">FREE SHIPPING</h6>
                                    <p>Get 10% cash back, free shipping, free
                                        returns, and more at 1000+ top
                                        retailers!</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="service-promo-single-item"
                                ...
                                <div class="image">
                                    <img
                                        src="assets/images/icons/service-promo-6.png"
                                        alt>
                                </div>
                                <div class="content">
                                    <h6 class="title">30 DAYS MONEY BACK</h6>
                                    <p>100% satisfaction guaranteed, or get your
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="service-promo-single-item"
                                ...
                                <div class="image">
                                    <img
                                        src="assets/images/icons/service-promo-7.png"
                                        alt>
                                </div>
                                <div class="content">
                                    <h6 class="title">SAFE PAYMENT</h6>
                                    <p>Pay with the world’s most popular and
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="service-promo-single-item"
                                ...
                                <div class="image">
                                    <img
                                        src="assets/images/icons/service-promo-8.png"
                                        alt>
                                </div>
                                <div class="content">
                                    <h6 class="title">LOYALTY CUSTOMER</h6>
                                    <p>Card for the other 30% of their purchases
                                        at a rate of 1% cash back.</p>
                                </div>
                            </div>
                        </div>
                        <!-- End Service Promo Single Item -->
        ...
        <div class="banner-section section-top-gap-100">
            <div class="banner-wrapper clearfix">
                ...
                <a href="{{ route('productdetails') }}">
                    <div
                        class="banner-single-item banner-style-7 banner-animation banner-color--green float-left"
                        data-aos="fade-up" data-aos-delay="0">
                        <div class="image">
                            <img class="img-fluid"
                                src="assets/images/banner/banner-style-7-img-1.jpg"
                                alt>
                        </div>
                    </div>
                </a>
                ...
                <a href="{{ route('productdetails') }}">
                    <div
                        ...
                        <div class="image">
                            <img class="img-fluid"
                                src="assets/images/banner/banner-style-7-img-2.jpg"
                                alt>
                        </div>
                    </div>
                </a>
                ...
                <a href="{{ route('productdetails') }}">
                    <div
                        ...
                        <div class="image">
                            <img class="img-fluid"
                                src="assets/images/banner/banner-style-7-img-3.jpg"
                                alt>
                        </div>
                    </div>
                </a>
                        ...
                        <div class="col-12">
                            <div class="section-content-gap">
                                <div class="secton-content">
                                    <h3 class="section-title">the New
                                        arrivals</h3>
                                    <p>Preorder now to receive exclusive deals &
                                        gifts</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="product-wrapper" data-aos="fade-up"
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div
                                class="product-slider-default-2rows default-slider-nav-arrow">
                                <!-- Slider main container -->
                                <div
                                    class="swiper-container product-default-slider-4grid-2row">
                                    <!-- Additional required wrapper -->
                                    <div class="swiper-wrapper">
                                        ...
                                        <div
                                            ...
                                            <div class="content">
                                                <div class="content-left">
                                                    <h6 class="title"><a
                                                            href="{{ route('productdetails') }}">Aliquam
                                                            lobortis</a></h6>
                                        ...
                                        <div
                                            ...
                                            <div class="content">
                                                <div class="content-left">
                                                    <h6 class="title"><a
                                                            href="{{ route('productdetails') }}">Condimentum
                                                            posuere</a></h6>
                                                    <ul class="review-star">
                                                        <li class="fill"><i
                                                                class="ion-android-star"></i></li>
                                        ...
                                        <div
                                            ...
                                            <div class="content">
                                                <div class="content-left">
                                                    <h6 class="title"><a
                                                            href="{{ route('productdetails') }}">Cras
                                                            neque metus</a></h6>
                                                    <ul class="review-star">
                                                        <li class="fill"><i
                                                                class="ion-android-star"></i></li>
                                        ...
                                        <div
                                            ...
                                            <div class="image-box">
                                                <a
                                                    ...
                                                    class="image-link">
                                                    <img
                                                        src="assets/images/product/default/home-3/default-7.jpg"
                                                        alt>
                                                    <img
                                                        src="assets/images/product/default/home-3/default-8.jpg"
                                                        alt>
                                                </a>
                                                <div class="action-link">
                                                    <div
                                            ...
                                            <div class="content">
                                                <div class="content-left">
                                                    <h6 class="title"><a
                                                            href="{{ route('productdetails') }}">Donec
                                                            eu libero
                                                            ac</a></h6>
                                                    <ul class="review-star">
                                                        <li class="fill"><i
                                        ...
                                        <div
                                            ...
                                            <div class="image-box">
                                                <a
                                                    ...
                                                    class="image-link">
                                                    <img
                                                        src="assets/images/product/default/home-3/default-9.jpg"
                                                        alt>
                                                    <img
                                                        src="assets/images/product/default/home-3/default-10.jpg"
                                                        alt>
                                                </a>
                                                <div class="action-link">
                                                    <div
                                            ...
                                            <div class="content">
                                                <div class="content-left">
                                                    <h6 class="title"><a
                                                            href="{{ route('productdetails') }}">Epicuri
                                                            per
                                                            lobortis</a></h6>
                                                    <ul class="review-star">
                                                        <li class="fill"><i
                                        ...
                                        <div
                                            ...
                                            <div class="image-box">
                                                <a
                                                    ...
                                                    class="image-link">
                                                    <img
                                                        src="assets/images/product/default/home-3/default-11.jpg"
                                                        alt>
                                                    <img
                                                        src="assets/images/product/default/home-3/default-3.jpg"
                                                        alt>
                                            ...
                                            <div class="content">
                                                <div class="content-left">
                                                    <h6 class="title"><a
                                                            href="{{ route('productdetails') }}">Kaoreet
                                                            lobortis
                                                            sagit</a></h6>
                                                    <ul class="review-star">
                                                        <li class="fill"><i
                                        ...
                                        <div
                                            ...
                                            <div class="content">
                                                <div class="content-left">
                                                    <h6 class="title"><a
                                                            href="{{ route('productdetails') }}">Convallis
                                                            quam sit</a></h6>
                                                    <ul class="review-star">
                                                        <li class="fill"><i
                                                                class="ion-android-star"></i></li>
                                        ...
                                        <div
                                            ...
                                            <div class="content">
                                                <div class="content-left">
                                                    <h6 class="title"><a
                                                            href="{{ route('productdetails') }}">Dolorum
                                                            fuga eget</a></h6>
                                                    <ul class="review-star">
                                                        <li class="fill"><i
                                                                class="ion-android-star"></i></li>
                                        ...
                                        <div
                                            ...
                                            <div class="content">
                                                <div class="content-left">
                                                    <h6 class="title"><a
                                                            href="{{ route('productdetails') }}">Duis
                                                            pulvinar
                                                            obortis</a></h6>
                                                    <ul class="review-star">
                                                        <li class="fill"><i
        ...
        <div class="banner-section section-top-gap-100">
            <div class="banner-wrapper clearfix">
                ...
                <a href="{{ route('productdetails') }}">
                    <div
                        class="banner-single-item banner-style-8 banner-animation banner-color--green float-left"
                        data-aos="fade-up" data-aos-delay="0">
                        <div class="image">
                            <img class="img-fluid"
                                src="assets/images/banner/banner-style-8-img-1.jpg"
                                alt>
                        </div>
                    </div>
                </a>
                ...
                <a href="{{ route('productdetails') }}">
                    <div
                        ...
                        <div class="image">
                            <img class="img-fluid"
                                src="assets/images/banner/banner-style-8-img-2.jpg"
                                alt>
                        </div>
                    </div>
                </a>
                        ...
                        <div class="col-12">
                            <div class="section-content-gap">
                                <div class="secton-content">
                                    ...
                                    <p>Add our best sellers to your weekly
                                        lineup.</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="product-wrapper" data-aos="fade-up" data-aos-delay="0">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div
                                class="product-slider-default-1row default-slider-nav-arrow">
                                <!-- Slider main container -->
                                <div
                                    class="swiper-container product-default-slider-4grid-1row">
                                    <!-- Additional required wrapper -->
                                    <div class="swiper-wrapper">
                                        <!-- End Product Default Single Item -->
                                        <!-- Start Product Default Single Item -->
        ...
        <div
            class="blog-default-slider-section section-top-gap-100 section-fluid">
            <!-- Start Section Content Text Area -->
            <div class="section-title-wrapper" data-aos="fade-up"
                data-aos-delay="0">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="section-content-gap">
                                <div class="secton-content">
                                    <h3 class="section-title">THE LATEST
                                        BLOGS</h3>
                                    <p>Present posts in a best way to highlight
                                        interesting moments of your blog.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="blog-wrapper" data-aos="fade-up" data-aos-delay="200">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div
                                class="blog-default-slider default-slider-nav-arrow">
                                <!-- Slider main container -->
                                <div class="swiper-container blog-slider">
                                    ...
                                    <div class="swiper-wrapper">
                                        <!-- Start Product Default Single Item -->
                                        <div
                                            class="blog-default-single-item blog-color--pink swiper-slide">
                                            <div class="image-box">
                                                <a
                                                    href="{{ route('blog') }}"
                                                    class="image-link">
                                            ...
                                            <div class="content">
                                                <h6 class="title"><a
                                                        href="{{ route('detailblog') }}">Blog
                                                        Post One</a></h6>
                                                <p>Donec vitae hendrerit arcu,
                                                ...
                                                <div class="inner">
                                                    <a
                                                        href="{{ route('detailblog') }}"
                                                        class="read-more-btn icon-space-left">Read
                                                        More <span><i
        ...
        <div class="company-logo-section section-top-gap-100 section-fluid">
            <div class="company-logo-wrapper" data-aos="fade-up"
                data-aos-delay="0">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div
                                class="company-logo-slider default-slider-nav-arrow">
                                <!-- Slider main container -->
                                <div
                                    class="swiper-container company-logo-slider">
                                    <!-- Additional required wrapper -->
                                    <div class="swiper-wrapper">
                                        <!-- Start Company Logo Single Item -->
                                        <div
                                            class="company-logo-single-item swiper-slide">
                                            <div class="image"><img
                                                    class="img-fluid"
                                ...
                                <!-- If we need navigation buttons -->
                                <div
                                    class="swiper-button-prev d-none d-md-block"></div>
                                <div
                                    class="swiper-button-next d-none d-md-block"></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="row mb-n6">
                            <div class="col-lg-3 col-sm-6 mb-6">
                                ...
                                <div
                                    class="footer-widget-single-item footer-widget-color--pink"
                                    data-aos="fade-up" data-aos-delay="0">
                                ...
                                <div class="footer-newsletter"
                                    ...
                                    <div class="form-newsletter">
                                        <form action="#" method="post">
                                            <div
                                                class="form-fild-newsletter-single-item input-color--pink">
                                                <input type="email"
