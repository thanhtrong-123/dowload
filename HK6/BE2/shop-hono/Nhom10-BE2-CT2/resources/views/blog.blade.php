...
<html lang="zxx">
    ...
    <!-- Mirrored from htmldemo.hasthemes.com/hono/hono/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Jan 2021 00:32:25 GMT -->
        ...
        <div class="breadcrumb-section breadcrumb-bg-color--golden">
            <div class="breadcrumb-wrapper">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h3 class="breadcrumb-title">Blog Grid - Full
                                Width</h3>
                            <div
                                ...
                                <nav aria-label="breadcrumb">
                                    <ul>
                                        ...
                                        <li><a
                                                href="blog-grid-sidebar-left.html">Blog</a></li>
                                        <li class="active"
                                            aria-current="page">Blog Full
                                            Width</li>
                                    </ul>
                                </nav>
                            </div>
                        ...
                        <div class="blog-wrapper">
                            <div class="row mb-n6">
                                <div class="col-xl-4 col-md-6 col-12 mb-6">
                                    ...
                                    <div
                                        class="blog-list blog-grid-single-item blog-color--golden"
                                        ...
                                        <div class="content">
                                            ...
                                            <h6 class="title"><a
                                                    href="{{ route('detailblog') }}">
                                                    Blog image post</a></h6>
                                            <p>Donec vitae hendrerit arcu, sit
                                                amet faucibus nisl. Cras pretium
                                                arcu ex. Aenean posuere libero
                                                eu augue condimentum rhoncus.
                                                Praesent</p>
                                            <a href="{{ route('detailblog') }}"
                                                class="read-more-btn icon-space-left">Read
                                                More <span class="icon"><i
                                ...
                                <div class="col-xl-4 col-md-6 col-12 mb-6">
                                    ...
                                    <div
                                        ...
                                        <div class="blog-list-slider-arrow">
                                            ...
                                            <div
                                                class="blog-list-slider swiper-container">
                                                <!-- Additional required wrapper -->
                                                <div class="swiper-wrapper">
                                                    <!-- Slides -->
                                                    <div
                                                        class="blog-list-slider-img swiper-slide"><img
                                                            class="img-fluid"
