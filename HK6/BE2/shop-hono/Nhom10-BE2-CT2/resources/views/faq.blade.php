...
<html lang="zxx">
    ...
    <!-- Mirrored from htmldemo.hasthemes.com/hono/hono/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Jan 2021 00:32:25 GMT -->
        ...
        <div class="breadcrumb-section breadcrumb-bg-color--golden">
            <div class="breadcrumb-wrapper">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h3 class="breadcrumb-title">Frequently Askd
                                Questions</h3>
                            <div
                                ...
                                <nav aria-label="breadcrumb">
                                    <ul>
                                        ...
                                        <li class="active"
                                            aria-current="page">Frequently Asked
                                            Questions</li>
                                    </ul>
                                </nav>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="faq-content" data-aos="fade-up"
                            data-aos-delay="0">
                            <h5 class="title">Below are frequently asked
                                questions, you may find the answer for
                                yourself</h5>
                            <p>Lorem ipsum dolor sit amet, consectetur
                                adipiscing elit. Donec id erat sagittis,
                                faucibus metus malesuada, eleifend turpis.
                                Mauris semper augue id nisl aliquet, a porta
                                lectus mattis. Nulla at tortor augue. In eget
                                enim diam. Donec gravida tortor sem, ac
                                fermentum nibh rutrum sit amet. Nulla convallis
                                mauris vitae congue consequat. Donec interdum
                                nunc purus, vitae vulputate arcu fringilla quis.
                        ...
                        <div class="col-12">
                            <div class="faq-accordian">
                                <div class="faq-accordian-single-item"
                                    ...
                                    <input id="item-1" name="accordian-item"
                                        type="radio" checked>
                                    <label for="item-1">Convenient User
                                        Interface</label>
                                    <div class="item-content">
                                        <p>Donec mattis finibus elit ut
                                            tristique. Nullam tempus nunc eget
                                            arcu vulputate, eu porttitor tellus
                                            commodo. Aliquam erat volutpat.
                                            Aliquam consectetur lorem eu viverra
                                ...
                                <div class="faq-accordian-single-item"
                                    ...
                                    <input id="item-2" name="accordian-item"
                                        type="radio">
                                    <label for="item-2">Lorem ipsum dolor sit
                                        amet.</label>
                                    <div class="item-content">
                                        <p>Donec mattis finibus elit ut
                                            tristique. Nullam tempus nunc eget
                                ...
                                <div class="faq-accordian-single-item"
                                    ...
                                    <input id="item-3" name="accordian-item"
                                        type="radio">
                                    <label for="item-3">Aliquid esse atque
                                        eveniet fugiat ullam</label>
                                    <div class="item-content">
                                        <p>Donec mattis finibus elit ut
                                            tristique. Nullam tempus nunc eget
                                            arcu vulputate, eu porttitor tellus
                                ...
                                <div class="faq-accordian-single-item"
                                    ...
                                    <input id="item-4" name="accordian-item"
                                        type="radio">
                                    <label for="item-4">Tenetur, facilis neque
                                        error earum facere
                                ...
                                <div class="faq-accordian-single-item"
                                    ...
                                    <input id="item-5" name="accordian-item"
                                        type="radio">
                                    <label for="item-5">Perspiciatis ut ipsa cum
                                        molestias quaerat laborum.</label>
                                    <div class="item-content">
                                        <p>Donec mattis finibus elit ut
                                            tristique. Nullam tempus nunc eget
                                            arcu vulputate, eu porttitor tellus
                                ...
                                <div class="faq-accordian-single-item"
                                    ...
                                    <input id="item-6" name="accordian-item"
                                        type="radio">
                                    <label for="item-6">Responsive
                                        Design</label>
                                    <div class="item-content">
                                        <p>Donec mattis finibus elit ut
                                            tristique. Nullam tempus nunc eget
