...
namespace Project_LTUD
{
    public partial class ThongtinNHACC : Form
    {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            textBox4.Text = dataGridView1.Rows[dong].Cells[2].Value.ToString();
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlParameter paratennhacc = new SqlParameter("@TENNHACC", SqlDbType.NVarChar);
                paratennhacc.Value = textBox2.Text;
                cmd.Parameters.Add(paratennhacc);

                SqlParameter paradiachinhacc = new SqlParameter("@DIACHINCC", SqlDbType.NVarChar);
                paradiachinhacc.Value = textBox3.Text;
                cmd.Parameters.Add(paradiachinhacc);

                SqlParameter paramapn = new SqlParameter("@MAPN", SqlDbType.NVarChar);
                paramapn.Value = textBox4.Text;
        ...
        {
           INNHACC nhacc = null;
            if (nhacc == null || nhacc.IsDisposed)
            {
                nhacc = new INNHACC();
                nhacc.Show();
