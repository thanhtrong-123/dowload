...
namespace Project_LTUD
{
    public partial class frmMain : Form
    {
        ...
        ThongtinNHACC ttncc = null;
        ThongtinLOAIXE ttlx = null;
        ...
        {
            if (ttlx == null || ttlx.IsDisposed)
            {
                ttlx = new ThongtinLOAIXE();
                ttlx.Show();
                ttlx.MdiParent = this;
            }
            else
        ...
        {
            if (ttncc == null || ttncc.IsDisposed)
            {
                ttncc = new ThongtinNHACC();
                ttncc.Show();
