    ...
    public partial class ThongtinLOAIXE : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.Connection = conn;
                SqlParameter paramaloai = new SqlParameter("@MALOAI", SqlDbType.NVarChar);
                paramaloai.Value = textBox1.Text;
                cmd.Parameters.Add(paramaloai);

                SqlParameter paratenloai = new SqlParameter("@TENLOAI", SqlDbType.NVarChar);
                paratenloai.Value = textBox2.Text;
                cmd.Parameters.Add(paratenloai);

                SqlParameter parapk = new SqlParameter("@PK", SqlDbType.NVarChar);
                parapk.Value = textBox3.Text;
