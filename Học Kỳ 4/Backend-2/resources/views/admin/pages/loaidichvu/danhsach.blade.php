                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <ul class="breadcome-menu">
                                        ...
                                        <li><span class="bread-blod">Loại dịch vụ</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="dropdown keep-open btn-group" id="mr-sort-asc">
                                                ...
                                                <ul class="dropdown-menu animated zoomIn">
                                                  ...
                                                  <li><a href="javascript:void(0)" onclick="orderByData('ten_danh_muc', 'ASC')">Danh mục</a></li>
                                                  <li><a href="javascript:void(0)" onclick="orderByData('ten', 'ASC')">Tên loại dịch vụ</a></li>
                                                </ul>
                                            </div>
                                            ...
                                            <ul class="dropdown-menu animated zoomIn" role="menu">
                                                ...
                                                <li role="menuitem"><a href="javascript:void(0)" onclick="orderByData('ten_danh_muc', 'DESC')">Danh mục </a></li>
                                                <li role="menuitem"><a href="javascript:void(0)" onclick="orderByData('ten', 'DESC')">Tên loại dịch vụ </a></li>
                                            </ul>
                                            <button class="btn btn-success pull-right" onclick="showModalAdd({{$danh_muc_dich_vu}})">Thêm mới</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar" data-unique-id="id">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="ten_danh_muc">Danh mục</th>
                                                <th data-field="ten">Tên loại dịch vụ</th>
                                                <th data-field="option">Tùy chọn</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach($loai_dich_vu as $loai_dich_vu)
                                            <tr>
                                                <td></td>
                                                <td>{{ $loai_dich_vu->id }}</td>
                                                <td>{{ $loai_dich_vu->ten_danh_muc }}</td>
                                                <td>{{ $loai_dich_vu->ten }}</td>
                                                <td>
                                                    <button title="Chỉnh sửa" class="pd-setting-ed" onclick="editID({{$loai_dich_vu->id}}, this)">
                                                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                    </button>
                                                    <button title="Xóa" class="pd-setting-ed" onclick="deleteID({{$loai_dich_vu->id }});">
...
@section('admin_script')
    ...
    <script src="js/admin/loaidichvu/danhsach.js"></script>
@endsection