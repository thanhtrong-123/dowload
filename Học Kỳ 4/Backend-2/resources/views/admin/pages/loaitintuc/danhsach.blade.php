                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <ul class="breadcome-menu">
                                        ...
                                        <li><span class="bread-blod">Loại tin tức</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="dropdown keep-open btn-group" id="mr-sort-asc">
                                                ...
                                                <ul class="dropdown-menu animated zoomIn">
                                                  ...
                                                  <li><a href="javascript:void(0)" onclick="orderByData('ten', 'ASC')">Tên loại tin tức</a></li>
                                                </ul>
                                            </div>
                                            ...
                                            <ul class="dropdown-menu animated zoomIn" role="menu">
                                                ...
                                                <li role="menuitem"><a href="javascript:void(0)" onclick="orderByData('ten', 'DESC')">Tên loại tin tức </a></li>
                                            </ul>
                                            <button class="btn btn-success pull-right" onclick="showModalAdd({{$danh_muc_tin_tuc}})">Thêm mới</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar" data-unique-id="id">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="ten">Tên loại tin tức</th>
                                                <th data-field="option">Tùy chọn</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach($loai_tin_tuc as $loai_tin_tuc)
                                            <tr>
                                                <td></td>
                                                <td>{{ $loai_tin_tuc->id }}</td>
                                                <td>{{ $loai_tin_tuc->ten_danh_muc }}</td>
                                                <td>{{ $loai_tin_tuc->ten }}</td>
                                                <td>
                                                    <button title="Chỉnh sửa" class="pd-setting-ed" onclick="editID({{$loai_tin_tuc->id}}, this)">
                                                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                    </button>
                                                    <button title="Xóa" class="pd-setting-ed" onclick="deleteID({{$loai_tin_tuc->id }});">
...
@section('admin_script')
    ...
    <script src="js/admin/loaitintuc/danhsach.js"></script>
