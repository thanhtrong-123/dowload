...
@section('title')
Thể loại tin tức - Trung tâm Minh Duy
@endsection
	...
	<div class="container">
		<div class="breadcrumb-content">
			<ul>
				...
				<li class="active">{{$loai_tin_tucs->ten}}</li>
			</ul>
		</div>
	</div>
</div> 
						...
						<div class="li-blog-single-item pb-25">
							...
							<div class="li-blog-content">
								<div class="li-blog-details">
									<h3 class="li-blog-heading pt-25"><a href="tin-tuc/{{changeTitle($ttl->tieu_de)}}a{{$ttl->id}}.html">{{$ttl->tieu_de}}</a></h3>
									<div class="li-blog-meta">
										<a class="author" href="tin-tuc/{{changeTitle($ttl->tieu_de)}}a{{$ttl->id}}.html"><i class="fa fa-user"></i>{{$ttl->display_name}}</a>
										<a class="comment" href="tin-tuc/{{changeTitle($ttl->tieu_de)}}a{{$ttl->id}}.html"><i class="fa fa-eye"></i>{{$ttl->luot_xem}} đã xem</a>
