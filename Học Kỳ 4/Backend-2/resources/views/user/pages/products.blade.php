...
@section('title')
Mọi sản phẩm - Trung tâm Minh Duy
@endsection
                                        ...
                                        <div class="col-lg-4">
                                            <div class="shop-add-action mb-xs-30">
                                                <ul class="add-actions-link">
                                                    ...
                                                    <li class="wishlist"><a class="view-list-product" href="javascript:void(0)" onclick="themSpYeuThich({{$sptl->id}})"><i class="fa fa-heart-o"></i>Add to wishlist</a></li>
                                                    <li><a class="quick-view view-list-product" data-toggle="modal" data-target="#xemnhanhsanpham{{$sptl->id}}" href="#"><i class="fa fa-eye"></i>Quick view</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
