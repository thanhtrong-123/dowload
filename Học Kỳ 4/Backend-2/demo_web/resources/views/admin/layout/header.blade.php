                                        ...
                                        <div class="header-right-info">
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item nav-setting-open"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                    ...
                                                    <div role="menu" class="admintab-wrap menu-setting-wrap menu-setting-wrap-bg dropdown-menu animated zoomIn notifications-setting">
                                                        <ul class="nav nav-tabs custon-set-tab">
                                                            <li class="active"><a data-toggle="tab" href="#Notesa">Đặt hàng</a>
                                                            </li>
                                                            @if(count($share_thong_bao_phan_hoi_sp) > 0)
                                                            ...
                                                            <li><a data-toggle="tab" href="#Settingsa">Phản hồi chung</a>
                                                            </li>
                                                        </ul>

                                                        <div class="tab-content custom-bdr-nt">
                                                            <div id="Notesa" class="tab-pane fade in active">
                                                            ...
                                                            <div id="Settingsa" class="tab-pane fade">
                                                ...
                                                <li class="nav-item nav-setting-open">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                        @if($share_dem_is_watched_ho_tro > 0)
                                                        <i class="educate-icon educate-menu text-warning" onclick="showMenu(this,{{$share_dem_is_watched_ho_tro}})"></i>
                                                        @else
                                                    ...
                                                    <div role="menu" class="admintab-wrap menu-setting-wrap menu-setting-wrap-bg dropdown-menu animated zoomIn">
                                                        <ul class="nav nav-tabs custon-set-tab">
                                                            <li class="active">
                                                                <a data-toggle="tab" href="#Notes">
                                                                    @if($share_dem_is_read_ho_tro > 0)
                                                                    <span class="text-danger">Hỗ trợ</span></a>
                                                                    @else
                                                                    <span>Hỗ trợ</span></a>
                                                                    @endif
                                                            </li>
                                                        ...
                                                        <div class="tab-content custom-bdr-nt">
                                                            <div id="Notes" class="tab-pane fade in active">
                                                                <div class="notes-area-wrap">
                                                                    <div class="note-heading-indicate">
                                                                        <p><span><i class="fa fa-envelope-o"></i></span> <a href="quantri/chamsockhachhang/hotro">Bạn có {{$share_dem_is_read_ho_tro}} tin nhắn mới.</a></p>
                                                                    </div>
                                                                </div>
                                                            </div>
