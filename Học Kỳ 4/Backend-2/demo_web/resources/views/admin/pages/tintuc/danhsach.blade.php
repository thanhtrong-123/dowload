                                        ...
                                        <div class="col-md-5 class-display-none">
                                            <div class="dropdown keep-open btn-group" id="mr-sort-asc">
                                                ...
                                                <ul class="dropdown-menu animated zoomIn">
                                                  ...
                                                  <li><a href="javascript:void(0)" onclick="orderByData('tieu_de', 'ASC')">Tiêu đề tin tức</a></li>
                                                  <li><a href="javascript:void(0)" onclick="orderByData('admin_ten', 'ASC')">Tác giả</a></li>
                                            ...
                                            <ul class="dropdown-menu animated zoomIn" role="menu">
                                                ...
                                                <li role="menuitem"><a href="javascript:void(0)" onclick="orderByData('tieu_de', 'DESC')">Tiêu đề tin tức </a></li>
                                                <li role="menuitem"><a href="javascript:void(0)" onclick="orderByData('admin_ten', 'DESC')">Tác giả </a></li>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar" data-unique-id="id">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="admin_ten">Tác giả</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $tin_tuc->id }}</td>
                                                <td class="images-tt">
                                                    <img src="uploads/images/news/{{ $tin_tuc->hinh_anh }}" alt="">
                                                </td>
                                                <td class="tieu-de-tt">{{ $tin_tuc->tieu_de }}</td>
                                                <td>{{ limitStrlen($tin_tuc->mo_ta, 300) }}</td>
                                                <td class="tac-gia-tt">{{ $tin_tuc->admin_ten }}</td>
                                                <td>{{ $tin_tuc->loai_ten }}</td>
                                                <td>{{ date("d/m/Y", strtotime($tin_tuc->created_at))}} </td>
                                                <td class="option-tt">
                                                    <button title="Chỉnh sửa" class="pd-setting-ed" onclick="editID({{$tin_tuc->id}}, this)">
                                                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                    </button>
                                                    <button title="Xóa" class="pd-setting-ed" onclick="deleteID({{$tin_tuc->id }});">
...
@section('admin_script')
    ...
    <script>
        ...
        function editID(id){
            window.location.href="quantri/tintuc/chinhsua/" + id
        }
        function add(){
            window.location.href="quantri/tintuc/them"
        }
