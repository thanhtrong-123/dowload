                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <ul class="breadcome-menu">
                                        ...
                                        <li><span class="bread-blod">Loại sản phẩm</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="dropdown keep-open btn-group" id="mr-sort-asc">
                                                ...
                                                <ul class="dropdown-menu animated zoomIn">
                                                  ...
                                                  <li><a href="javascript:void(0)" onclick="orderByData('ten', 'ASC')">Tên loại sản phẩm</a></li>
                                                </ul>
                                            </div>
                                            ...
                                            <ul class="dropdown-menu animated zoomIn" role="menu">
                                                ...
                                                <li role="menuitem"><a href="javascript:void(0)" onclick="orderByData('ten', 'DESC')">Tên loại sản phẩm </a></li>
                                            </ul>
                                            <button class="btn btn-success pull-right" onclick="showModalAdd({{$danh_muc_sp}})">Thêm mới</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar" data-unique-id="id">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="ten">Tên loại sản phẩm</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td></td>
                                                <td>{{ $loai_sp->id }}</td>
                                                <td>{{ $loai_sp->ten_danh_muc }}</td>
                                                <td>{{ $loai_sp->ten }}</td>
                                                <td>
                                                    <button title="Chỉnh sửa" class="pd-setting-ed" onclick="editID({{$loai_sp->id}}, this)">
                                                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                    </button>
                                                    <button title="Xóa" class="pd-setting-ed" onclick="deleteID({{$loai_sp->id }});">
...
@section('admin_script')
    ...
    <script src="js/admin/loaisanpham/danhsach.js"></script>
