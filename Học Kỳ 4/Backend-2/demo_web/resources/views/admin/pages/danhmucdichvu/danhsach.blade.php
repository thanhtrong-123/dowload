                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <ul class="breadcome-menu">
                                        ...
                                        <li><span class="bread-blod">Danh mục dịch vụ</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar" data-unique-id="id">
                                        ...
                                        <tbody>
                                            @foreach($danh_muc_dich_vu as $danh_muc_dich_vu)
                                            <tr>
                                                <td></td>
                                                <td>{{ $danh_muc_dich_vu->id }}</td>
                                                <td>{{ $danh_muc_dich_vu->ten }}</td>
                                                <td>
                                                    <button title="Chỉnh sửa" class="pd-setting-ed" onclick="editID({{$danh_muc_dich_vu->id}}, this)">
                                                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                    </button>
                                                    <button title="Xóa" class="pd-setting-ed" onclick="deleteID({{$danh_muc_dich_vu->id }});">
...
@section('admin_script')
    ...
    <script src="js/admin/danhmucdichvu/danhsach.js"></script>
@endsection